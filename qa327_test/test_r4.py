...
def test_successful_case(capsys):
    ...
    expected_tail_of_terminal_output = ['Welcome the Queens ticket trade machine',
                                        ...
                                        'register  login  exit',
                                        'exit']
    expected_output_transactions = 'selling,test_name,asd123,50,10'
...
def test_ticket_name_no_longer_than_60(capsys):
    terminal_input = ['login', 'test@test.com,Pass123..', 'sell', 'asd123asdfasdfasasdjkfhaknschfiawehncfikasnkascfasdfvarfehnsfgbtghsgvdfgbstfdfgbyfdgbdfgvftfdfbgfdvgbgfvgbfgbfdgbfhngbnhgbgghb,50,10,20201010', 'logout', 'exit']
    expected_tail_of_terminal_output = ['Welcome the Queens ticket trade machine',
                                        'type your choice:',
                                        'register  login  exit',
                                        'login session started successfully',
